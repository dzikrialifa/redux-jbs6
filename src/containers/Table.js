    ...
    render(){
         ...
         <div className="col-lg-10 offset-lg-1 col-md-10 col-sm-12 col-xs-12">
            ...
            {this.props.todos.length !== 0 ? (
                <table style={{marginTop:"60px"}} className="table table-hover table-dark">
                    ...
                    <tbody>
                        {this.props.todos.map(todo => (
                            <tr key={todo.id}>
                            <td style={{ textDecoration: todoCompleted ? "line-through" : "none" }}>  {todo.text} {todo.completed === true ? "(completed)" : ""} </td>
                            <td>
                                ...
                                <span className="fas fa-check-cirlce" onClick={ () => this.props.toggleTodo(todo.id)} style={{color:"white",fontSize: "20pt"}}/>
                            </td>
                            </tr>
                        ))}
                    </tbody>
                ...
                <div className="col-lg-10 col-md-10 col-xs-12 col sm 12 offset-lg-1">
